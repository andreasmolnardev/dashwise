...
export default function IconPickerComponent({
    ...
    const groupedIcons: Record<string, Icon[]> = filteredIcons.reduce((acc, icon) => {
    ...
    return (
        <div>
            ...
            <Input
                ...
                className="frosted w-full mb-0.5 p-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary"
            />
                        ...
                        <div key={letter}>
                            ...
                            >
                                {groupedIcons[letter].map((icon) => (
                                    ...
                                    >
                                        <RadioGroupItem value={icon.Reference} className="hidden" />
                                        <img
                                            src={getIconUrl(icon)}
                                            alt={icon.Name}
                                            loading="lazy"
