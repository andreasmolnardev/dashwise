...
export default function WidgetComponent(
  ...
  const [Component, setComponent] = useState<React.FC<WidgetItemProps> | null>(
    null,
  );
      ...
      try {
        ...
        switch (type) {
          ...
          case "weather-upcoming":
            imported = {
              default: (await import("./dashboard/Weather"))?.default,
            };
            break;
          case "weather-overview":
            imported = {
              default: (await import("./dashboard/Weather"))
