...
const enableSSOLogin =
  ...
  process.env.NEXT_PUBLIC_ENABLE_SSO === "1" || false;

const disableUserSignup =
  process.env.NEXT_PUBLIC_DISABLE_USER_SIGNUP === "true" ||
  process.env.NEXT_PUBLIC_DISABLE_USER_SIGNUP === "1" || false;

const enableJobsWebhook =
  process.env.NEXT_PUBLIC_JOBS_WEBHOOK_ENABLE === "true" ||
